(function(){
  ...
  const s=document.createElement('script');s.src='cheques-devueltos.js?v=20260917140';s.onload=montar;s.onerror=()=>console.error('No se pudo cargar cheques-devueltos.js');document.body.appendChild(s);
})();
